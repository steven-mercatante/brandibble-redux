...
export default function status(state = initialState, action) {
  switch (action.type) {
    ...
    case DISPLAY_MENU_FETCH_START:
      return { ...state, fetchDisplayMenu: PENDING };
    case DISPLAY_MENU_FETCH_SUCCESS:
      return { ...state, fetchDisplayMenu: FULFILLED };
    case DISPLAY_MENU_FETCH_ERROR:
      return { ...state, fetchDisplayMenu: REJECTED };
